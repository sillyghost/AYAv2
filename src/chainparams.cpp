...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.aryacoin.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("aryacointools.com", "dnsseed.aryacointools.com"));
        vSeeds.push_back(CDNSSeedData("aryacoinpool.org", "dnsseed.aryacoinpool.org"));
